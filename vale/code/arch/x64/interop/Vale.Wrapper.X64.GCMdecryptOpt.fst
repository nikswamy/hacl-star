...
val gcm128_decrypt_opt':
  ...
  Stack UInt64.t
    (requires fun h0 ->
      ...
      B.disjoint tag_b abytes_b /\ B.disjoint tag_b auth_b /\
      ...
      disjoint_or_eq tag_b hkeys_b /\ disjoint_or_eq tag_b keys_b /\
      disjoint_or_eq keys_b hkeys_b /\ B.disjoint keys_b auth_b /\
